...
import { X, Award, Zap, Check, Lock, Shield } from 'lucide-react';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
      <div className="relative w-full max-w-lg bg-[#121519] border border-white/[0.08] rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="p-6 space-y-6 max-h-[80vh] overflow-y-auto">
          {/* User Card */}
          <div className="p-5 rounded-2xl bg-[#181C22] border border-white/[0.08] flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-[#0A0C0E] border border-white/[0.08] flex items-center justify-center text-xl font-editorial font-black text-[#DCA842]">
          ...
          {isChangingClub && (
            <div className="p-4 rounded-2xl bg-[#0A0C0E] border border-white/[0.08] space-y-3">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="p-3.5 rounded-2xl bg-[#181C22] border border-white/[0.08] text-center">
            ...
            <div className="p-3.5 rounded-2xl bg-[#181C22] border border-white/[0.08] text-center">
              ...
              <span className="text-[10px] text-[#8B949E] block mt-0.5">{user.wins + user.losses} disputados</span>
            </div>

            <div className="p-3.5 rounded-2xl bg-[#181C22] border border-white/[0.08] text-center">
              <span className="text-[10px] uppercase font-semibold text-[#8B949E] block mb-1">Racha Activa</span>
              <span className="font-num font-black text-2xl text-[#10B981] flex items-center justify-center gap-1">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {user.achievements.map((ach) => (
                <div
                  key={ach.id}
                  className="p-3 rounded-xl bg-[#181C22] border border-white/[0.08] flex items-center justify-between gap-3"
                >
          ...
          {/* Próximamente: Sistemas en Desarrollo */}
          <div className="space-y-3 pt-2 border-t border-white/[0.08]">
            <h4 className="text-xs font-semibold uppercase tracking-wider text-[#8B949E]">
              Funcionalidades en Preparación
            </h4>

            <div className="space-y-2">
              <div className="p-3 rounded-xl bg-[#181C22]/50 border border-white/[0.04] flex items-center justify-between opacity-70">
                <div className="flex items-center gap-2.5">
                  <Lock className="w-3.5 h-3.5 text-[#8B949E]" />
                  <span className="text-xs text-[#F1EDE6]">Matchmaking 1v1 Online en Tiempo Real</span>
                </div>
                <span className="text-[10px] uppercase font-bold text-[#DCA842]">Próximamente</span>
              </div>

              <div className="p-3 rounded-xl bg-[#181C22]/50 border border-white/[0.04] flex items-center justify-between opacity-70">
                <div className="flex items-center gap-2.5">
                  <Lock className="w-3.5 h-3.5 text-[#8B949E]" />
                  <span className="text-xs text-[#F1EDE6]">Ligas Semanales de Hinchadas</span>
                </div>
                <span className="text-[10px] uppercase font-bold text-[#DCA842]">Próximamente</span>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[#181C22]/50 border border-white/[0.04] flex items-center justify-between opacity-70">
                <div className="flex items-center gap-2.5">
                  <Lock className="w-3.5 h-3.5 text-[#8B949E]" />
                  <span className="text-xs text-[#F1EDE6]">Recompensas por Racha de Temporada</span>
                </div>
                <span className="text-[10px] uppercase font-bold text-[#DCA842]">Próximamente</span>
              </div>
            </div>
